...
INPUT_PARAMETERS = {'racetrack_height': 10e-3, 'racetrack_width': 40e-3, 'racetrack_length': 80e-3,
                    'octagon_height': 20e-3, 'octagon_width': 60e-3, 'octagon_length': 80e-3,
...
def racetrack_to_octagonal_cavity_model(input_parameters):
    ...
    try:
        ...
        wire4, face4 = make_octagonal_aperture(input_parameters['octagon_height'] + input_parameters['pipe_thickness'],
                                               ...
                                               input_parameters['octagon_side_length'],
                                               input_parameters['octagon_tb_length'])
        vac1 = make_beampipe(face1, input_parameters['racetrack_length'],
        ...
        vac2 = make_taper(wire2, wire1, input_parameters['taper_length'],
                            (-input_parameters['octagon_length'] / 2., 0, 0), (0, 180, 0))
        vac3 = make_beampipe(face2, input_parameters['octagon_length'])
        ...
        taper1 = make_taper(wire4, wire3, input_parameters['taper_length'],
                            (-input_parameters['octagon_length'] / 2., 0, 0), (0, 180, 0))
        beampipe2 = make_beampipe(face4, input_parameters['octagon_length'])
...
parameter_sweep(racetrack_to_octagonal_cavity_model, INPUT_PARAMETERS, OUTPUT_PATH, 'octagon_width', [40e-3, 80e-3, 100e-3])
...
parameter_sweep(racetrack_to_octagonal_cavity_model, INPUT_PARAMETERS, OUTPUT_PATH, 'racetrack_height', [15e-3, 20e-3, 25e-3, 30e-3])
